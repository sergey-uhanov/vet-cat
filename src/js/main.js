...
document.addEventListener('DOMContentLoaded', async e => {
    initHeader()
    heightFirstSection()
    tripleSlider('triple-slider_services','triple-slider__button-next-icon_service', 'triple-slider__button-prev-icon_service')
    tripleSlider('triple-slider_experts','triple-slider__button-next-icon_experts', 'triple-slider__button-prev-icon_experts')
    quadrupleSlider('triple-slider_stories','triple-slider__button-next-icon_stories', 'triple-slider__button-prev-icon_stories')
