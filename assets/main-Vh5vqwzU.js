import{g as s,a as m,c as g,d as w,i as _}from"./firebase-kXAzlJEp.js";import{S as u,t as p,e as v}from"./experts-slider-inner-wSVdsCHb.js";function f(){const e=s(".first-screen__background"),t=s(".first-screen");t.style.height=getComputedStyle(e).height,window.addEventListener("resize",()=>{t.style.height=getComputedStyle(e).height})}async function b(){return(await m(g(w,"cards-services"))).docs.map(t=>({id:t.id,...t.data()}))}function y(e){const t=s(".service-slider"),r=s(".swiper-wrapper",t);e.forEach(i=>{const a=`
                            ...
                            </div>`;r.insertAdjacentHTML("beforeend",a)})}async function S(){try{const e=await b();y(e)}catch(e){console.error(e)}}function k(e,t,r){new u(`.${e}`,{slidesPerView:4,spaceBetween:40,loop:!0,navigation:{nextEl:`.${t}`,prevEl:`.${r}`},breakpoints:{320:{slidesPerView:"auto",spaceBetween:20},1100:{slidesPerView:4,spaceBetween:40}}})}function L(e){const t="/vet-cat/";return` <a class="swiper-slide small-img-card" href="#">
                    <div class="small-img-card__img-wrapper">
                        <picture>
                            <source srcset="${t}img/home/${e.linkWebp}" type="image/webp">
                            <img class="small-img-card__img" src="${t}img/home/${e.linkPng}" alt="photo animals"
