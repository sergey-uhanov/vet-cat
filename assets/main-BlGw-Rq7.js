import{g as s,a as m,c as g,d as w,i as _}from"./firebase--kS5HU57.js";import{S as u,t as p,e as v}from"./experts-slider-inner-D_rAmi7B.js";function f(){const e=s(".first-screen__background"),t=s(".first-screen");t.style.height=getComputedStyle(e).height,window.addEventListener("resize",()=>{t.style.height=getComputedStyle(e).height})}async function b(){return(await m(g(w,"cards-services"))).docs.map(t=>({id:t.id,...t.data()}))}function y(e){const t=s(".service-slider"),r=s(".swiper-wrapper",t);e.forEach(i=>{const a=`
